...
$(document).ready(function() {
    ...
    //Enable save after something changed
    //$('input').on('keyup', function() {
        $('button.save').removeClass('disabled');
        $('button.save').on('click', function() {
            $('form.account input[type="submit"]').trigger('click');
            return false;
        });
    //});
...
function showResponse(responseText, statusText, xhr, $form)  {
    ...
    if(responseText.status === true) {
        //##: TODO: indicate success to the user somehow visually, perhaps with a button icon change loading spinner
    } else {
